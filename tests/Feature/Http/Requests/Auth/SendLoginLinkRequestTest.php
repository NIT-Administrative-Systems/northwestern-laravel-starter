...
#[CoversClass(SendLoginLinkRequest::class)]
class SendLoginLinkRequestTest extends TestCase
{
    public function test_authorize_returns_true(): void
    {
        $request = new SendLoginLinkRequest();
    ...
    {
        $request = SendLoginLinkRequest::create('/', 'POST', [
