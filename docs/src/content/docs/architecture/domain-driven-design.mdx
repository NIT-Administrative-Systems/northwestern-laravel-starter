...
:::tip
For enums that will be represented in the Filament UI, consider implementing [available interfaces](https://filamentphp.com/docs/5.x/advanced/enums) like `HasLabel` so they integrate seamlessly.
:::
