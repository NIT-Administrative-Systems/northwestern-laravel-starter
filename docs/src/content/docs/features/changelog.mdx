...
<PropertyTable title="Front Matter">
    <Property name="slug" required>
        URL-safe identifier used as the filename and URL path segment
    </Property>
    <Property name="date" required>
        Authored date in `YYYY-MM-DD` format
    </Property>
    <Property name="title" required>
        Human-readable title displayed in the changelog header
    </Property>
</PropertyTable>
...
<PropertyTable>
    <Property name="CHANGELOG_ENABLED" default="false">
        Enable changelog routes and navigation
    </Property>
    <Property name="JIRA_URL" default="https://nuitadminsystems.atlassian.net">
        Base URL of your Jira instance
    </Property>
    <Property name="JIRA_ISSUE_IDENTIFIER">
        Jira project key for auto-linking (e.g. `GSTS`)
    </Property>
</PropertyTable>
