...
import { PropertyTable, Property, PropertyGroup } from '@nu-appdev/northwestern-starlight-theme/components';
...
- **Contract** - `TicketSystemGateway` interface decouples orchestration from gateway implementations
- **Enum-driven resolution** - `TicketSystem::gatewayClass()` maps each driver to its concrete class
- **Immutable value object** - `CreationResult` carries the outcome of each gateway call
- **Repository** - Keeps persistence concerns out of the action
- **Action** - `CreateSupportTicket` orchestrates the workflow in one place
...
The [TeamDynamix](https://services.northwestern.edu/TDNext) (TDX) gateway submits tickets to the TDX REST API using the [`northwestern-sysdev/tdx-php-sdk`](https://github.com/NIT-Administrative-Systems/tdx-php-sdk) package. The SDK handles authentication and token management, and covers a broad surface beyond ticket creation: people/group lookups, service catalog queries, and metadata management. Configuration is published to `config/team-dynamix.php`.
...
<PropertyTable>
    <Property name="RATE_LIMIT_SUPPORT_CONTACT_PER_MINUTE" default="2">
        Submissions per minute
    </Property>
    <Property name="RATE_LIMIT_SUPPORT_CONTACT_PER_HOUR" default="5">
        Submissions per hour
    </Property>
    <Property name="RATE_LIMIT_SUPPORT_CONTACT_PER_DAY" default="10">
        Submissions per day
    </Property>
</PropertyTable>
...
<PropertyTable>
    ...
    <Property name="SUPPORT_ENABLED" default="false">
        Enable the contact form and submission routes
    </Property>
    <Property name="SUPPORT_LIMITED_WARNING" default="true (non-production)">
        Show limited support warning banner
    </Property>
    <Property name="SUPPORT_DRIVER" default="mail">
        Gateway driver (`mail`, `team-dynamix`)
    </Property>
    <Property name="SUPPORT_MAIL_TO" default="your-team@northwestern.edu">
        Support team email address
    </Property>
    <Property name="SUPPORT_REFERENCE_PREFIX" default="SUP">
        Reference prefix for mail gateway (e.g. `SUP-47`)
    </Property>
    <PropertyGroup title="TeamDynamix" />
    <Property name="TDX_API_BASE_URL" required>
        TDX REST API base URL
    </Property>
    <Property name="TDX_USERNAME" required>
        TDX service account username
    </Property>
    <Property name="TDX_PASSWORD" required>
        TDX service account password
    </Property>
    <Property name="TDX_TICKET_APP_NAME" required>
        TDX application name
    </Property>
    <Property name="TDX_CLIENT_APP_NAME" required>
        TDX client application name
    </Property>
    <Property name="TDX_ASSIGNEE_ID" required>
        TDX group ID for ticket assignment (required for TDX driver)
    </Property>
    <Property name="TDX_TICKET_TYPE" default="Default">
        TDX ticket type name
    </Property>
    <Property name="TDX_FORM_TYPE" default="NU Base Service Request">
        TDX form type name
    </Property>
    <Property name="TDX_TICKET_STATUS" default="New">
        TDX ticket status name
    </Property>
    <Property name="TDX_TICKET_PRIORITY" default="Low (P4)">
        TDX ticket priority name
    </Property>
    <Property name="TDX_SERVICE" default="APP_NAME">
