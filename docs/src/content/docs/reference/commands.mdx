...
<PropertyTable title="Options">
    <Property name="--show-dependencies" type="flag">
        Show full dependency tree
    </Property>
    <Property name="--mermaid" type="flag">
        Output as Mermaid diagram
    </Property>
    <Property name="--json" type="flag">
        Output as JSON
    </Property>
</PropertyTable>
...
<PropertyTable title="Options">
    <Property name="filename" type="argument">
        Descriptive name for the snapshot. Defaults to `database-dump` if omitted.
    </Property>
    <Property name="--skip-schema-validation" type="flag">
...
<PropertyTable title="Options">
    ...
    <Property name="--backup" type="flag">
        Create a backup of the current database before restoring
    </Property>
    <Property name="--force" type="flag">
...
<PropertyTable title="Options">
    <Property name="--max-attempts" type="option" default="5">
        Maximum number of connection attempts (1-20)
    </Property>
    <Property name="--delay" type="option" default="5">
...
<Aside type="tip">
The `description` parameter on `#[StarterValidator]` controls the label shown in the command output. The `shouldRun()` method determines whether the validator is relevant. Return `false` for optional integrations that aren't configured to avoid false negatives.
</Aside>
...
<PropertyTable title="Options">
    <Property name="--version-file" type="option">
