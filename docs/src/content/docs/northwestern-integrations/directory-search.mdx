...
<PropertyTable>
    <Property name="DIRECTORY_SEARCH_URL" default="https://northwestern-prod.apigee.net/directory-search">
        Directory Search API base URL
    </Property>
    <Property name="DIRECTORY_SEARCH_API_KEY" required>
        Apigee API key for Directory Search
    </Property>
    <Property name="DIRECTORY_SEARCH_HEALTH_CHECK_NETID" default="swd2981">
