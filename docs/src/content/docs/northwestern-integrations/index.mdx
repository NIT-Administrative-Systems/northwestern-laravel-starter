...
The starter integrates with Northwestern-specific services for identity management, user provisioning, lifecycle events, and ticketing. Most integrations use the [`northwestern-sysdev/laravel-soa`](https://github.com/NIT-Administrative-Systems/SysDev-laravel-soa) package, which provides Laravel bindings for Northwestern's SOA APIs.
