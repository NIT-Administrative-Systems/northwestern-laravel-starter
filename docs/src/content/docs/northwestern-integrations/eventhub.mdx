...
<PropertyTable>
    <Property name="EVENT_HUB_BASE_URL" required>
        EventHub API base URL
    </Property>
    <Property name="EVENT_HUB_API_KEY" required>
        Apigee API key for EventHub
    </Property>
    <Property name="EVENT_HUB_HMAC_VERIFICATION_SHARED_SECRET" required>
        Shared secret for HMAC signature verification
    </Property>
    <Property name="EVENT_HUB_HMAC_VERIFICATION_HEADER" default="X-HMAC-Signature">
        HTTP header containing the HMAC signature
    </Property>
    <Property name="EVENT_HUB_HMAC_VERIFICATION_ALGORITHM_TYPE_REGISTRATION" default="HmacSHA256">
        Algorithm name sent to EventHub during registration
    </Property>
    <Property name="EVENT_HUB_HMAC_VERIFICATION_ALGORITHM_TYPE_PHP" default="sha256">
        PHP `hash_hmac` algorithm name
    </Property>
    <Property name="EVENT_HUB_MOCK_ENABLED" default="true (local)">
